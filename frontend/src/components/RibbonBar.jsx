    ...
    <div className="sticky top-0 bg-white shadow-sm z-10 p-4 border-b">
      ...
      <div className="relative">
        {showLeftScroll && (
          ...
          >
            <svg role="img" aria-label="Scroll Left" className="w-6 h-6 text-linkedin-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {Object.keys(visibleSections).map(section => (
            profile[section] && (
              <div key={section} className="flex-shrink-0 flex items-center bg-gray-50 rounded-full px-3 py-1">
                ...
                >
                  <svg role="img" aria-label="Copy Section" className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 5H6a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2v-1M8 5a2 2 0 002 2h2a2 2 0 002-2M8 5a2 2 0 012-2h2a2 2 0 012 2m0 0h2a2 2 0 012 2v3m2 4H10m0 0l3-3m-3 3l3 3" />
                  </svg>
                </button>
              </div>
        ...
        {showRightScroll && (
          ...
          >
            <svg role="img" aria-label="Scroll Right" className="w-6 h-6 text-linkedin-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
